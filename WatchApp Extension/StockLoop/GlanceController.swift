...
//  WatchApp Extension
//
//  The Sport Mode glance screen (docs/DESIGN_SPORT_UI.md): layout A
...
//  - Stale glucose NEVER looks fresh: number dims, arrow drops, explicit age (§6a).
//  - Color only OUT of range: white in range, amber high, red low.
...
//  - Suspended shows the auto-resume countdown as primary state, not an alarm.
