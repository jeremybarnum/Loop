...
// Modified from LoopKit/OmniBLE for watchOS port: added explicit imports. The
// original relied on the Xcode module umbrella for Foundation/CoreBluetooth;
// SwiftPM requires them to be imported per-file.
import Foundation
