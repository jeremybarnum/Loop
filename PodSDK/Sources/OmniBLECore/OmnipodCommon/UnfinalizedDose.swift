...
// Modified from LoopKit/OmniBLE for watchOS port: removed `extension NewPumpEvent`
// (init from UnfinalizedDose). NewPumpEvent is a LoopKit persistence type used only
// by OmniBLEPumpManager, which is not part of the portable driver core.
