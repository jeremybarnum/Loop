...
final class WatchDataManager: NSObject {
    ...
    private(set) lazy var podLoanController: PodLoanPhoneController = {
        ...
        // Predicted-low snooze wiring intentionally ABSENT on this line: the closures stay
        // nil, the grant carries a nil snooze, and the wrist (engine-less here) stays silent.
        // The personal-mods line wires them to its LoopDataManager snooze clock.
        return controller
    }()
